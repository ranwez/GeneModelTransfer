import pytest
import polars as pl
from CANDIDATE_LOCI.gff_utils import get_coding_regions, get_longest_intron, parse_gff, GeneInfo, gff_to_geneInfo, sort_gff, Bounds
...
def test_gff_to_geneInfo():
    ...
    exp_info= GeneInfo (
        ...
        chr_id="1",
        coding_region=Bounds(153634301,153645269),
        strand=1,
        longest_intron=3797
    )
