...
def main():
    ...
    parser.add_argument("-o", "--output", metavar='CDS.bed', type=str, required=True, help="Name of the output bed.")
    ...
    with open(args.output, "w") as out_file:
        for gene in gene_info.values():
            out_file.write(f"{gene.chr_id}\t{gene.coding_start}\t{gene.coding_end}\t{gene.gene_id}\n")
